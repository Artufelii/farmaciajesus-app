...
#[tauri::command]
pub fn fetch_pacientes() -> Vec<Paciente> { 
...
#[tauri::command]
pub fn get_paciente(paciente_id: i32) -> Paciente {
    use crate::schema::pacientes::dsl::*;
    let connection = &mut establish_connection();
...
#[tauri::command]
pub fn create_paciente(data: CrearPaciente) {
    use crate::schema::pacientes::dsl::*;
    let connection = &mut establish_connection();
...
#[tauri::command]
pub fn update_paciente(data: ActualizarPaciente) {
    use crate::schema::pacientes::dsl::*;
    let connection = &mut establish_connection();
...
#[tauri::command]
pub fn delete_paciente(paciente_id: i32){
    use crate::schema::pacientes::dsl::*;
